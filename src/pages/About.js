...
function About(props) {
  return (
    <>
      ...
      <ul className="aboutParagraphs">
        Our target groups are secondary schoolstudents aged 14-17, who will have
        the opportunity of taking active part in a multilateral projectthat they
        would otherwise have no access to, given their particular social,
        economic or academic disadvantage. Such opportunity will broaden their
        minds and it will increase their Europeansense of belonging, preventing
        racist, intolerant and chauvinistic behaviors. The project is based on
        the analysis of four main topics both through collaborative work on the
        eTwinning platformand by means of four short-term group exchanges
